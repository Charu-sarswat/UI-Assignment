  ...
  return (
    <footer className="border-t border-slate-200 bg-white py-6 text-sm text-slate-500 sm:py-8">
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-2 gap-6 pb-6 sm:grid-cols-4 sm:gap-8 sm:pb-8">
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="mt-3 flex gap-2 sm:mt-4 sm:gap-3">
              <a
                href="#"
                className="flex items-center justify-center rounded-full border border-slate-200 p-2 text-slate-500 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-900"
                aria-label="Twitter"
              >
                <svg
                  className="h-4 w-4"
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1.5 sm:mt-4 sm:space-y-2">
              {companyLinks.map((link) => (
                <li key={link}>
                  <a href="#" className="text-xs transition hover:text-blue-600 sm:text-sm">
                    {link}
                  </a>
                </li>
              ))}
        ...
        <div className="flex flex-col gap-3 border-t border-slate-100 pt-4 text-center text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:pt-6 sm:text-left sm:text-sm">
          <p>© {new Date().getFullYear()} DevFlow. Built for demo purposes.</p>
          <div className="flex justify-center gap-4 sm:justify-end sm:gap-6">
