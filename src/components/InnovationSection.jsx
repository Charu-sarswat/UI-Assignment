      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="relative px-8 sm:px-12 md:px-16 lg:px-20">
          ...
          {isSecondSet && (
            <button
              onClick={handlePrev}
              className="absolute left-0 top-1/2 z-10 -translate-y-1/2 rounded-full bg-blue-600 p-2 sm:p-2.5 md:p-3 text-white shadow-lg transition hover:bg-blue-700"
          ...
          <div
            className={`grid gap-4 sm:gap-5 md:gap-6 grid-cols-1 ${
              isFirstSet ? "md:grid-cols-[2fr_1fr]" : "md:grid-cols-[1fr_2fr]"
            }`}
          >
            {visibleCards.map((feature, index) => (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 md:gap-4">
                  <button className="flex items-center justify-center gap-1.5 sm:gap-2 rounded-lg bg-blue-600 px-3 py-2 text-xs sm:text-sm font-semibold text-white transition hover:bg-blue-700 sm:px-4 sm:py-2 md:px-6 md:py-3">
                  ...
                  <button className="text-xs sm:text-sm md:text-base font-semibold text-blue-600 transition hover:text-blue-700 text-center sm:text-left">
          ...
          {isFirstSet && (
            <button
              onClick={handleNext}
              className="absolute right-0 top-1/2 z-10 -translate-y-1/2 rounded-full bg-blue-600 p-2 sm:p-2.5 md:p-3 text-white shadow-lg transition hover:bg-blue-700"
