          ...
          <nav className="flex gap-4 sm:gap-6 md:gap-8 overflow-x-auto pb-2">
            {industrySolutions.map((solution) => (
              <button
                ...
                className={`whitespace-nowrap border-b-2 pb-4 text-sm font-medium transition ${
            ...
            <div className="absolute left-0 top-0 h-full w-full md:w-[55%] lg:w-[50%]">
              <div className="flex h-full items-center p-4 sm:p-6 md:p-8 lg:p-12">
                <div className="rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 md:p-8 shadow-2xl">
                  ...
                  <button className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-blue-700 sm:px-6 sm:py-3 sm:text-base">
